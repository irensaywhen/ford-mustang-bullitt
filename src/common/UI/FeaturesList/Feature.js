...
const Feature = ({ text, image }) => {
  return (
    <div className='columns is-mobile is-multiline mb-2 px-4'>
      ...
      <div className='column is-flex is-justify-content-center is-align-items-center has-text-left-mobile has-text-centered-tablet'>
        {text}
      </div>
    </div>
  );
